        ...
        stage('Update_Plugins') {
            steps {
                script {
                    ...
                    safePluginUpdateModule.list_jenkins_plugins("${WORKSPACE}/admin-jobs/Update-Jenkins-Plugins", "plugins_list_BEFORE-UPDATE_${DATETIME}.txt")
                    (pluginsToReviewManually, pluginsDeprecated) = safePluginUpdateModule.jenkins_safe_plugins_update()
                    safePluginUpdateModule.list_jenkins_plugins("${WORKSPACE}/admin-jobs/Update-Jenkins-Plugins", "plugins_list_AFTER-UPDATE_${DATETIME}.txt")
                }
            }
        }
    }
